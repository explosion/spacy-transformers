    ...
    def from_bytes(self, bytes_data):
        ...
        if config_dict:
            ...
            try:
                ...
                warn_msg = (
                    "Unable to load torch state dict with strict=True. "
                    "Attempting to load with strict=False for backwards "
                    "compatibility with certain older saved models. If you see "
                    "errors or degraded performance, download a newer "
                    "compatible model or retrain your custom model with the "
                    "current transformers and spacy-transformers versions. For "
                    "more details and available updates, run: python -m spacy "
                    "validate"
                )
