# Stubs for pytorch_transformers.tokenization_xlm (Python 3)
#
...
class XLMTokenizer(PreTrainedTokenizer):
    ...
    bpe_ranks: Any = ...
    cache: Any = ...
    def __init__(self, vocab_file: Any, merges_file: Any, unk_token: str = ..., bos_token: str = ..., sep_token: str = ..., pad_token: str = ..., cls_token: str = ..., mask_token: str = ..., additional_special_tokens: Any = ..., **kwargs: Any) -> None: ...
    @property
    def vocab_size(self): ...
